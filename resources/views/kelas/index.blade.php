...
<div class="modal fade" id="modalUpload" data-bs-backdrop="static" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content" action="{{ route('jurusan.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-header">
                ...
                <div class="row">
                    <div class="col">
                        <p><i class='bx bx-info-circle'></i>Wajib menggunakan template, download file template <a
                                href="{{ route('jurusan.template') }}" class="btn-sm btn-info">Disini</a> </p>
                        <p class="text-white bg-danger"><i class='bx bx-info-circle'></i>Kolom kelas diisi dengan id dari kelas tersebut di sheet kedua  </p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
